...
function handleScroll(event) {
    ...
    if (nextIndex >= 0 && nextIndex < sections.length) {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                tempSection.remove();
                if (!sessionStorage.getItem('scrollNoti')) {
                    noti.warn('Scrolling does not update your cursor, move your cursor to get it back!');
                }
                sessionStorage.setItem('scrollNoti', true);
            }, 250);
        }, 600);
